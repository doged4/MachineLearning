...
fullMainArray = pickle.load( open( "/Users/cevbain/MachineLearning/TrumpPostFULLFinal.p", "rb" ) )
...
import os
images_dir = "TTestNowFixedChecking"
...
train(generator, discriminator, combined, epochs=1600, batch_size=32, save_interval=50)
